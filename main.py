...
pygame.display.set_caption("Car game by ananya")
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("SUS GAME",largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("Introducing to ananya's car game in which you need to dodge other cars. Have fun",smalltext)
